// Edited to add alpha from https://github.com/pmndrs/three-stdlib/blob/main/src/objects/Lensflare.js
    ...
    this.onBeforeRender = function (renderer, scene, camera) {
      ...
      if (validArea.containsPoint(screenPositionPixels)) {
        ...
        for (let i = 0, l = elements.length; i < l; i++) {
          ...
          uniforms['alpha'].value = element.alpha
...
class LensflareElement {
  constructor(texture, size = 1, distance = 0, color = new Color(0xffffff), alpha = 1) {
