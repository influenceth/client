// TODO: is this deprecated? seems like it's no longer in use
...
//     const massUsage = mass / inventoryConfig.massCapacity;
//     const massReservedUsage = reservedMass / inventoryConfig.massCapacity;
//     const volumeUsage = volume / inventoryConfig.volumeCapacity;
//     const volumeReservedUsage = reservedVolume / inventoryConfig.volumeCapacity;
...
//             <label>Stored:</label>
//             <span>
//               <b>{activeUse > 0 && activeUse < 0.05 ? '> ' : ''}{formatFixed(activeUse, 1)}</b> / {inventoryConfig[`${massOrVolume || 'mass'}Capacity`].toLocaleString()}{' '}
...
//               <span>
//                 <b>{reservedUse > 0 && reservedUse < 0.05 ? '> ' : ''}{formatFixed(reservedUse, 1)}</b> / {inventoryConfig[`${massOrVolume || 'mass'}Capacity`].toLocaleString()}{' '}
//                 {massOrVolume === 'volume' ? <>m<sup>3</sup></> : 'tonnes'}
//               </span>
//             </StorageTotal>
//           )}
